...
import com.example.evazoomapp.screens.mymeeting.rawdata.AudioRawDataUtil;
import com.example.evazoomapp.screens.mymeeting.rawdata.RawDataRender;
import com.example.evazoomapp.screens.mymeeting.rawdata.UserVideoAdapter;
...
public class RawDataMeetingActivity extends FragmentActivity implements InMeetingServiceListener, MeetingServiceListener,  InMeetingShareController.InMeetingShareListener, View.OnClickListener, UserVideoAdapter.ItemTapListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raw_data_meeting);
